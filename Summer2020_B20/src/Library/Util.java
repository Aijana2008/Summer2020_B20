...
//-----------------------------------------------STRING-----------------------------------------------------------------
    ...
    public static String uniques(String str) {
        String uniques = "";
        for (char each : str.toCharArray()) {
            int count = frequency(str, each); // finds the frequency of every character
            if (count == 1) {
                uniques += each;
            }
        }
    ...
    public static String FrequencyOfChars(String str) {
        ...
        String nonDup = Util.removeDup(str); // A B C
    ...
    //-----------------------------------------ARRAYS-----------------------------------------------------------------------
    // finds and returns the maximum number from in array
    ...
    // finds and returns the maximum number from Integer array
    ...
    // finds and returns the maximum number from double array
    ...
    // finds and returns the minimum number from int array
    ...
    // // finds and returns the minimum number from double array
    ...
    // finds and returns the minimum number from Integer array
    ...
    //double,Double,Integer,char, Character, String array napravi ih posle casa
